...
function ConfirmEmailPage() {
  ...
  return (
    <div className='h-full flex items-center justify-center'>
      <div className='flex flex-col gap-4 p-8 items-center bg-white w-72 -mt-40 rounded-md shadow-sm'>
        ...
        <span className='text-xl font-semibold'>Confirmar Email</span>
        <span className='text-center text-sm'>Uma mensagem para verificação de conta foi enviada ao seu email</span>
        <button onClick={() => { navigate('/') }} className='primary-button w-full bg-blue-700'>Fazer login</button>
      </div>
    </div>
  )
}
